            ...
            <div className="bg-gray-800 p-4 rounded-lg shadow-md mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                        ...
                        className="p-2 rounded-lg bg-gray-700 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                    />
                    <select
                        value={statusFilter}
                    ...
                    <table className="min-w-full text-sm">
                        ...
                        <tbody className="divide-y divide-gray-700">
                            {filteredPedidos.map((pedido) => (
                                <tr key={pedido._id} className="hover:bg-gray-700 transition-colors">
                                    <td className="p-3 font-mono text-xs" onClick={() => setPedidoSelecionado(pedido)}>{pedido._id.slice(-6)}</td>
        ...
        >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-yellow-500">Pedido #{pedidoSelecionado._id}</h3>
                <button
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-2">
                            ...
                            <button
                                className="bg-gray-600 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded-lg w-full transition-colors"
